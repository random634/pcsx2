...
static __fi void _cpuTestTIMR()
{
	...
	{
		Log::Console.info(LogStyle::CompatibilityMagenta, "timr intr: {:x}, {:x}\n", cpuRegs.CP0.n.Count, cpuRegs.CP0.n.Compare);
...
void __fastcall eeGameStarting()
{
	...
	{
		Log::Console.info(LogStyle::CompatibilityGreen, "(R5900) Re-executed ELF Entry point (ignored) [addr=0x{:08X}]\n", ElfEntry);
	}
}
