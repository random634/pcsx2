...
void GSDrawScanlineCodeGenerator::TestZ(const Ymm& temp1, const Ymm& temp2)
{
	...
	if (m_sel.ztest)
	{
		...
		if (m_sel.zpsm)
		{
			vpslld(ymm1, (u8)(m_sel.zpsm * 8));
			vpsrld(ymm1, (u8)(m_sel.zpsm * 8));
		}
...
void GSDrawScanlineCodeGenerator::WriteZBuf()
{
	...
	{
		vpcmpeqd(ymm7, ymm7);
		vpsrld(ymm7, (u8)((m_sel.zpsm & 0x3) * 8));
		vpminsd(ymm1, ymm7);
	}
...
void GSDrawScanlineCodeGenerator::WritePixel(const Xmm& src, const Reg32& addr, u8 i, u8 j, int psm)
{
...
void GSDrawScanlineCodeGenerator::ReadTexel(const Ymm& dst, const Ymm& addr, u8 i)
{
	ASSERT(i < 4);
