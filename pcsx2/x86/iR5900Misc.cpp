...
void recNULL()
{
	Log::Console.error("EE: Unimplemented op {:x}\n", cpuRegs.code);
}
...
void recUnknown()
{
	...
	Log::Console.error("EE: Unrecognized op {:x}\n", cpuRegs.code);
}

void recMMI_Unknown()
{
	// TODO : Unknown ops should throw an exception.
	Log::Console.error("EE: Unrecognized MMI op {:x}\n", cpuRegs.code);
}

void recCOP0_Unknown()
{
	// TODO : Unknown ops should throw an exception.
	Log::Console.error("EE: Unrecognized COP0 op {:x}\n", cpuRegs.code);
}

void recCOP1_Unknown()
{
	// TODO : Unknown ops should throw an exception.
	Log::Console.error("EE: Unrecognized FPU/COP1 op {:x}\n", cpuRegs.code);
}
