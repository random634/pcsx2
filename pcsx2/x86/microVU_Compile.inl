...
static void __fc mVUbadOp0  (u32 prog, u32 pc) { Log::Console.error("microVU0 Warning: Exiting... Block contains an illegal opcode. [{:04x}] [{:03d}]\n", pc, prog); }
static void __fc mVUbadOp1  (u32 prog, u32 pc) { Log::Console.error("microVU1 Warning: Exiting... Block contains an illegal opcode. [{:04x}] [{:03d}]\n", pc, prog); }
static void __fc mVUwarning0(u32 prog, u32 pc) { Log::Console.error("microVU0 Warning: Exiting from Possible Infinite Loop [{:04x}] [{:03d}]\n", pc, prog); }
static void __fc mVUwarning1(u32 prog, u32 pc) { Log::Console.error("microVU1 Warning: Exiting from Possible Infinite Loop [{:04x}] [{:03d}]\n", pc, prog); }
static void __fc mVUprintPC1(u32 pc) { Log::Console.info("Block Start PC = 0x{:04x}\n", pc); }
static void __fc mVUprintPC2(u32 pc) { Log::Console.info("Block End PC   = 0x{:04x}\n", pc); }
